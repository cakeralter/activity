...
ADD activity-interfaces/target/activity-interfaces-0.0.1-SNAPSHOT.jar /home/app/activity.jar
#创建一个新的容器并在新的容器中运行命令
RUN bash -c 'touch /home/app/activity.jar'
#设置时区
ENV TZ=PRC
...
ENTRYPOINT ["java","-jar","/home/app/activity.jar"]